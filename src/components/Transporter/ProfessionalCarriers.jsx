              ...
              <div className="bg-white rounded-t-lg border-8 border-gray-900 p-3 shadow-2xl">
                ...
                <div className="bg-white rounded-md overflow-hidden">
                  <div className="flex">
                    ...
                    <div className="w-2/3 bg-gray-50 p-3 relative">
                      ...
                      <div className="w-full h-48 bg-gradient-to-br from-gray-200 via-gray-100 to-gray-200 rounded relative overflow-hidden">
                        ...
                        {/* Map markers */}
                        <div className="absolute top-1/4 left-1/3 w-3 h-3 bg-red-500 rounded-full border-2 border-white shadow-lg"></div>
                        <div className="absolute top-1/2 left-1/2 w-3 h-3 bg-blue-500 rounded-full border-2 border-white shadow-lg"></div>
                        <div className="absolute top-2/3 right-1/3 w-3 h-3 bg-green-500 rounded-full border-2 border-white shadow-lg"></div>
                  ...
                  <div className="bg-gray-50 border-t border-gray-200 p-2 flex items-center justify-between">
                    ...
                    <div className="h-1.5 w-16 bg-orange-400 rounded"></div>
                  </div>
                </div>
              </div>
